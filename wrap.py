...
from example1.processors.generic_argparse_processor import call
...
def wrap(
    ...
    loader_map = {
        ...
        for loader in flat_loader_list if loader.name != "__pycache__" and file.name.endswith(splitext(loader.name)[1])
    }
    ...
    print(f"Make sure that {output_path} is in your path, eg: export PATH={output_path}:$PATH") if debug_mode else None
call(wrap)
